...
transparent paper and wants you to fold the paper up (for horizontal y=... lines) or left
(for vertical x=... lines). In this example, the first fold instruction is fold along y=7,
...
folded; after the fold is complete, those dots appear in the top left corner (at 0,0 and 0,1).
...
the first fold in the example above, 17 dots are visible - dots that end up overlapping after 
