...
bootup.py + bootup.txt are used to solve first part as well as identify the
sequence used (i.e. firstsequence.txt). identifycorruption.py used to solve second part
