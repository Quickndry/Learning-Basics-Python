...
be able to make deliveries. We put the truck on a horizontal ground and measured
...
Could you calculate the remaining volume of the liquid? Your function tankvol(h,
d, vt) returns an integer which is the truncated result (e.g floor) of your float
calculation.
