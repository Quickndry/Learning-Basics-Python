The set of words is given. Words are joined if the last letter
 of one word and the first letter of another word are the same.
  Return true if all words of the set can be combined into one 
  word, or return false.

Input
List of 3 to 7 words of random length. There are no capital 
etters. Words in list may be repeated.
